...
func main() {
	...
	rsp, _, _ = AddItemToCar(client, url, rsp, cookieStr)
...
func AddItemToCar(client *resty.Client, url string, lastRsp *resty.Response, cookieStr string) (*resty.Response, int, error) {
	fmt.Printf("\n")
	fmt.Printf("\n")
	fmt.Printf("------------add item to car---------------------\n")
	request := client.R()
	request.SetHeader("cookie", cookieStr)
	AddCarRequestParam(lastRsp, request)
...
func PostReserveEntry(client *resty.Client, url string, lastRsp *resty.Response, cookieStr string) (*resty.Response, int, error) {
	fmt.Printf("\n")
	fmt.Printf("\n")
