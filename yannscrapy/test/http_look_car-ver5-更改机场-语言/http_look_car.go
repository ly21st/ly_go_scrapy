...
func main() {
	...
	url = "https://www.anadf.com/"
	//client.SetCookies(rsp.Cookies())
	//cookieStr := TransantCookies(client.Cookies)
	...
	//client.SetCookies(rsp.Cookies())
	//cookieStr = TransantCookies(client.Cookies)
	rsp, _, _ = CommonGetRequest(client, url, cookieStr, "get home page after change airport", "home-page2.html")
	fmt.Printf("rsp=%v", rsp.Status())
	...
	//client.SetCookies(rsp.Cookies())
	//cookieStr = TransantCookies(client.Cookies)
	rsp, _, _ = CommonGetRequest(client, url, cookieStr, "get home page after change language", "home-page3.html")
	fmt.Printf("rsp=%v", rsp.Status())
