...
// @Param   body     body    controller.RegisterInfo     true       "{`name`: xxx, `password`: xxx}"
// @Success 200
...
// @Accept application/json
// @Produce application/json
// @Param   body     body    model.LoginReq     true       "{`name`: xxx, `password`: xxx}"
// @Success 200
...
// @Accept application/json
// @Produce application/json
// @Param   token     header    string     true       "token=XXX"
// @Success 200
// @Router /web/auth/check-token [GET]
